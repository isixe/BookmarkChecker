...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Easily find and fix broken links in your bookmarks. Our free tool analyzes your bookmark file and provides a clear report.',
    url: siteUrl,
  ...
  twitter: {
    ...
    title: 'Bookmark Link Checker - Scan for Broken Links',
    description: 'Clean up your bookmarks! Find all dead and broken links with our fast, free, and secure online checker.',
